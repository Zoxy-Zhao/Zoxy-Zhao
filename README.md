...
**Edge AI / 端侧模型部署** ｜ AI 本科在读（2027 届）

专注把视觉模型部署进算力受限的端侧设备：模型轻量化、ONNX/TensorRT 推理优化、软硬件协同。
...
`PyTorch` `ONNX Runtime` `TensorRT` `OpenCV` `ROS2` ｜ `Python` `C` ｜ `Jetson` `Raspberry Pi` `Renesas RA6M5` `STM32`

## 📫 联系我

📮 zxy2016567076@gmail.com
